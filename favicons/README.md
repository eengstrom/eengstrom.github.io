...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/favicons/safari-pinned-tab.svg" color="#dc143c">
    <link rel="shortcut icon" href="/favicons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Irregular Motif">
    <meta name="application-name" content="Irregular Motif">
